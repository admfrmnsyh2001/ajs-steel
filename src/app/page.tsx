...
const WA_URL = 'https://wa.me/6288210596563?text=Halo%20AJS%20Steel%2C%20saya%20ingin%20konsultasi%20proyek.';
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href={WA_URL} target="_blank" rel="noreferrer" className="w-full sm:w-auto rounded-full bg-orange-600 px-8 py-4 text-sm font-bold text-white shadow-[0_0_20px_rgba(15,76,117,0.4)] hover:shadow-[0_0_30px_rgba(15,76,117,0.6)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2">
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mt-6 pt-5 border-t border-zinc-100 dark:border-zinc-800/80 flex items-center justify-between">
                      ...
                      <a href={WA_URL} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-orange-600 transition-all">
        ...
        <section className="py-24 px-6 sm:px-8 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            <a href={WA_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 bg-white text-orange-600 hover:bg-orange-50 px-10 py-4 rounded-full font-bold text-lg shadow-2xl hover:-translate-y-1 transition-all duration-300">
