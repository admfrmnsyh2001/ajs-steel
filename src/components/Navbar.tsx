    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* WhatsApp Button */}
          <a
            href="https://wa.me/6288210596563?text=Halo%20AJS%20Steel%2C%20saya%20ingin%20konsultasi%20proyek."
            target="_blank"
            rel="noreferrer"
            className="px-5 py-2.5 rounded-full text-sm font-semibold transition-all hover:-translate-y-0.5 shadow-lg flex items-center gap-2 bg-orange-600 hover:bg-orange-500 text-white shadow-orange-500/20"
          >
